                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a class="btn btn-primary" href="{{route('admin.sub-category.index')}}"><i class="fa-solid fa-arrow-left"></i> Quay lại</a>
                    </div>
                  </div>
                  <div class="card-body">
                   <form action="{{route('admin.sub-category.update',$sub_category->id)}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$sub_category->name}}" placeholder="Nhập tên">
                        @if ($errors->has('name'))
                      ...
                      <div class="form-group">
                        ...
                        <select id="inputStatus" class="form-control" name="status">
                          <option {{$sub_category->status == 1? 'selected' : ''}} value="1">Hiển thị</option>
                          <option {{$sub_category->status == 0? 'selected' : ''}} value="0">Ẩn</option>
                        </select>
                      </div>
